...

{
    ...
    console.log(Fn.id)*/
    //修饰类：需要传参；
    var test = function test(attr, value) {
        return function (target) {
            target[attr] = value;
        };
    };

    var test2 = function test2(target, attr, desc) {
        console.log(desc);
        desc.writable = true; //true:可编辑  false：不可编辑；
    };

    var Fn = (_dec = test('zIndex', 12330), _dec(_class = (_class2 = function () {
        function Fn() {
        ...
        return Fn;
    }(), (_applyDecoratedDescriptor(_class2.prototype, 'hello', [test2], Object.getOwnPropertyDescriptor(_class2.prototype, 'hello'), _class2.prototype)), _class2)) || _class);
