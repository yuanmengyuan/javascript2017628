...

{
    ...
    var test = function test(attr, val) {
        return function (target) {
            target[attr] = val;
        };
    };

    var testRead = function testRead(target, attr, des) {
        des.writable = false;
    };

    var Fn = (_dec = test('haha', 456), _dec(_class = (_class2 = function () {
        function Fn() {
        ...
        return Fn;
    }(), (_applyDecoratedDescriptor(_class2.prototype, 'test', [testRead], Object.getOwnPropertyDescriptor(_class2.prototype, 'test'), _class2.prototype)), _class2)) || _class);
